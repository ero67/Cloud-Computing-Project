...
2. BigQuery:
   ...
   - Tables:
     - `processed_data` (with timestamp and data_value columns)

### Troubleshooting
If you encounter issues:
1. Ensure GCP credentials are properly set up
2. Check Terraform logs in GitHub Actions
3. Verify permissions for service accounts
4. Review error messages in Pull Request comments